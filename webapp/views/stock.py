...
def home(code):
    ...
    return render_template('stock/home.html', title='成长-'+stock.name, mydate=date,code=code, stock=stock)
...
def blog(code):
    ...
    #price = stock.current_price
    return render_template('stock/blog2.html', title='日志-'+sname, code=code, stock=stock)
